...
export default {
    ...
    setup() {
        ...
        var projects = ref([
            ...
            { name: "Vue3 TheMovieDB Client App", html_url: "https://github.com/BusraOzcann/vue3-themoviedb-api-client", img_src: require('@/assets/images/Projects/vue/todo.png'), topics: ['Vuejs', 'Javascript', 'HTML', 'CSS',], description: "TheMovieDB API kullanarak oluşturulmuş netflix klon." },
            { name: "Vue-TODO", html_url: "https://github.com/BusraOzcann/vue-todo", img_src: "", topics: ['Vuejs', 'Javascript', 'HTML', 'CSS',], description: "Basit todo uygulaması" },
        ])
